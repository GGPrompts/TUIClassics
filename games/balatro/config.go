...
// loadConfigFile loads configuration from ~/.config/balatro-tui/config.yaml
...
func getConfigPath() string {
	...
	return filepath.Join(home, ".config", "balatro-tui", "config.yaml")
}
...
func getDefaultLogPath() string {
	...
	return filepath.Join(home, ".local", "share", "balatro-tui", "debug.log")
}
...
func createExampleConfig() error {
	...
	example := `# Balatro TUI Configuration File
...
logging:
  ...
  file: "~/.local/share/balatro-tui/debug.log"
`
